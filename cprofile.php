...
<head>
    ...
    <title>Company Profile | Dwi Star Muda | Web Developer Expert</title>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                <li><strong>Category</strong>: Company Profile</li>
                                <li><strong>Price</strong>: Mulai dari <a class="badge rounded-pill bg-primary" href="">Rp.1.499.000,-</a></li>
                            ...
                            <div class="text-center">
                                <a href="order?id=2" class="btn btn-primary">Pesan Sekarang</a>
                            </div>
                        </div>
                    </div>
