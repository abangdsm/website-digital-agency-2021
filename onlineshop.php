                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="assets/img/olshop.png" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/dashboard-custom.png" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/stisla.png" alt="">
                                </div>
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                <li><strong>Category</strong>: Toko Online</li>
                                <li><strong>Price</strong>: Mulai dari <a class="badge rounded-pill bg-primary" href="">Rp.2.499.000,-</a></li>
                                <ul><strong>Features</strong>:
                                    <li>Unlimited SSD Web Space</li>
                                    <li>Unlimited Bandwith</li>
                                    <li>Unlimited Database</li>
                                    <li>Unlimited Email</li>
                                    <li>Free Auto SSL</li>
                                    <li>Free Domain .my.id</li>
                                    <li>Terintegrasi Whatsapp Checkout</li>
                                    <li>Unlimited Produk</li>
                                    <li>Litespeed Web Server</li>
                                    <li>Siap Pakai</li>
                                    <li>Free Support 24/7</li>
                                    <li>Revisi 2x</li>
                                    <li>Perpanjangan tahun berikutnya hanya Rp.499.000,-</li>
                                </ul>
                            </ul>
                            <div class="text-center">
                                <a href="order?id=5" class="btn btn-primary">Pesan Sekarang</a>
                            </div>
                        </div>
                    </div>
