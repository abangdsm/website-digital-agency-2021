...
<head>
    ...
    <title>Rebuild Website | Dwi Star Muda | Web Developer Expert</title>
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <ol>
                    ...
                    <li>Rebuild Website</li>
                </ol>
                <h2>Rebuild Website</h2>
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="assets/img/rebuild1.png" alt="rebuildweb">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/rebuild2.png" alt="rebuildweb">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/rebuild3.png" alt="rebuildweb">
                                </div>
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                <li><strong>Category</strong>: Rebuild Website</li>
                                <li><strong>Price</strong>: <a class="badge rounded-pill bg-primary" href="https://thisoneway.com#footer"> You can call me.</a></li>
                                <ul><strong>Features</strong>:
                                    <li>Siap Pakai</li>
                                    <li>Free Support 24/7</li>
                                    <li>Free Konsultasi Fitur</li>
                                    <li>Kustomisasi Fitur</li>
                                    <li>Proses Pengerjaan 5-7 hari kerja.</li>
                                </ul>
                            </ul>
                            <div class="text-center">
                                <a href="order?id=6" class="btn btn-primary">Pesan Sekarang</a>
                            </div>
                        </div>
                    </div>
