...
<head>
    ...
    <title>Landing Page | Dwi Star Muda | Web Developer Expert</title>
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                <li><strong>Price</strong>: Mulai dari <a class="badge rounded-pill bg-primary" href="">Rp.499.000,-</a></li>
                                <ul><strong>Features</strong>:
                                    ...
                                    <li>Free Opt-In Form</li>
                                    <li>Perpanjangan tahun berikutnya hanya Rp.299.000,-</li>
                                </ul>
                            </ul>
                            <div class="text-center">
                                <a href="order?id=3" class="btn btn-primary">Pesan Sekarang</a>
                            </div>
                        </div>
                    </div>
