...
$client = query("SELECT * FROM tbclient ORDER BY id DESC");
...
<head>
    ...
    <title>Data Client | Dwi Star Muda | Web Developer Expert</title>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($client as $data) : ?>
                                            <tr>
                                                ...
                                                <td><?= $data["whatsapp"]; ?></td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="#"><i class="bi bi-info"></i></a>
