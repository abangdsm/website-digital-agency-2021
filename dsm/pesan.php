...
$id = $_GET["id"];
$isipesan = query("SELECT * FROM tbpesan WHERE id=$id")[0];

$data = mysqli_query($conn, "SELECT * FROM tbpesan ORDER BY id DESC");
...
<head>
    ...
    <title>Pesan | Dwi Star Muda | Web Developer Expert</title>
...
<body>
    ...
    <main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                <h2>Pesan | Dwi Star Muda | Web Developer Expert</h2>
        ...
        <section id="portfolio-details" class="portfolio-details">
            <div class="container">
                ...
                <div class="row gy-4 mb-5">
                    <div class="col-lg-4">
                        <div class="portfolio-info" style="max-height: 300px; overflow:auto;">
                            <h3>Pesan Masuk</h3>
                            <table class="table">
                                <tr>
                                    <th>No.</th>
                                ...
                                <?php foreach ($data as $pesan) : ?>
                                    <tr>
                                        ...
                                        <td><?= $pesan["nama"]; ?></td>
                                        <td>
                                            <a class="btn btn-success btn-sm" href="?id=<?= $pesan["id"]; ?>"><i class="bi bi-eye"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                    ...
                    <div class="col-lg-8">
                        <div class="portfolio-info">
                            <h3>Pesan Masuk</h3>
                            <p>
                                Pengirim : <?= $isipesan["nama"]; ?> | <a href=""><?= $isipesan["email"]; ?></a> | <?= $isipesan["whatsapp"]; ?>
                            </p>
                            <hr>
                            <?= $isipesan["pesan"]; ?>
                            <hr>
                            <a class=" btn btn-danger btn-sm" href=""><i class="bi bi-envelope"></i></a>
                            <a class="btn btn-success btn-sm" href=""><i class="bi bi-whatsapp"></i></a>
                            <a class="btn btn-warning btn-sm" href=""><i class="bi bi-trash"></i></a>
                        </div>
                    </div>
                </div>
